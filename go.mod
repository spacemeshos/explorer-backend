...
require (
	...
	github.com/spacemeshos/go-spacemesh v1.7.6
...
require (
	...
	github.com/spacemeshos/merkle-tree v0.2.4 // indirect
	github.com/spacemeshos/poet v0.10.4 // indirect
	github.com/spacemeshos/post v0.12.9 // indirect
